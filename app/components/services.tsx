...
export const ServicesList = () => {
  return (
    <section id="services" className="w-full bg-[black] relative font-sans text-white py-24 sm:py-32 border-t border-gray-900">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col xl:flex-row gap-16 lg:gap-24">
        ...
        <div className="w-full xl:w-[30%]">
          <div className="xl:sticky xl:top-32 border-l-4 border-[#E43E3D] pl-6 flex flex-col items-start text-left">
